...
## [0.5.0](https://github.com/toon-format/toon-rust/compare/v0.4.6...v0.5.0) - 2026-05-22

### Added

- *(layout)* expose decoder layout metadata behind cargo feature ([#66](https://github.com/toon-format/toon-rust/pull/66))

### Other

- Deserialization failure for u64 values larger than i64::MAX ([#67](https://github.com/toon-format/toon-rust/pull/67))

## [0.4.6](https://github.com/toon-format/toon-rust/compare/v0.4.5...v0.4.6) - 2026-05-19

### Added

- Add JSON streaming encode support ([#65](https://github.com/toon-format/toon-rust/pull/65))

## [0.4.5](https://github.com/toon-format/toon-rust/compare/v0.4.4...v0.4.5) - 2026-03-30

### Fixed

- preserve exact text for unquoted string values (#62(Fixes #59, #60, #61))

## [0.4.4](https://github.com/toon-format/toon-rust/compare/v0.4.3...v0.4.4) - 2026-03-04

### Fixed

- array elements starting with number followed by text parsed as string ([#57](https://github.com/toon-format/toon-rust/pull/57))
...
- fixes bugs and spec alignment ([#52](https://github.com/toon-format/toon-rust/pull/52))

## [0.4.1](https://github.com/toon-format/toon-rust/compare/v0.4.0...v0.4.1) - 2025-12-20

### Added

- gate cli features ([#41](https://github.com/toon-format/toon-rust/pull/41))

### Other

- standardize CONTRIBUTING.md structure
- remove community health files (now using org defaults)
- update spec compliance issue-template
